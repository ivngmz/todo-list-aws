...
class TestDatabaseFunctions(unittest.TestCase):
    ...
    def test_put_todo_error(self):
        ...
        with pytest.raises(botocore.exceptions.ClientError({'Error': {'Code': 'ResourceNotFoundException', 'Message': 'Not Found'}},"Exception")) as exc_info:
            put_item(
                "",
                self.dynamodb
            )
    ...
    def test_update_todo_error(self):
        ...
        self.assertRaises(
            ...
            update_item(
                ...
                "",
                self.dynamodb))
        with pytest.raises(botocore.exceptions.ClientError(ValueError,"ValueError")) as exc_info:
            update_item(
                "",
                "",
                "",
